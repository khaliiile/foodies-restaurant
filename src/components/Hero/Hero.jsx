        ...
        <div className="container pb-8 sm:pb-0">
          <div className="grid grid-cols-1 sm:grid-cols-2">
            ...
            >
              ...
              <p className="text-sm ">
               <i>
                 Welcome to Foodie Haven, where passion meets plate in a celebration of culinary delights. Situated in the heart of the city, Foodie Haven is more than just a restaurant; it's a gastronomic journey that caters to the discerning palates of food enthusiasts and connoisseurs alike.
               </i>
              </p>
              <div>
